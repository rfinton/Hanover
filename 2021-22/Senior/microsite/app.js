...
if (purl && location.hostname == 'youbelonghere.hanover.edu' && location.pathname == `/${purl}/redirect_lp.html`) {
	fetch(`https://youbelonghere.hanover.edu/seeds/${purl}/seeds.html`)
}